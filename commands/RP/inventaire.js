...
module.exports.run = async (bot, message, args, data, userInfo) => {
  ...
  InventaireLIST=[
    [userInfo.INVENTAIRE.inventaire.Peau,1,loot1],
    [userInfo.INVENTAIRE.inventaire.Griffe,1,loot2],
    [userInfo.INVENTAIRE.inventaire.Viande,2,loot1],
    [userInfo.INVENTAIRE.inventaire.Bois,2,loot2],
    [userInfo.INVENTAIRE.inventaire.Sabot,3,loot1],
    [userInfo.INVENTAIRE.inventaire.Dent,5,loot1],
    [userInfo.INVENTAIRE.inventaire.Ecaille,5,loot2],
    [userInfo.INVENTAIRE.inventaire.Carapace,7,loot1],
    [userInfo.INVENTAIRE.inventaire.Mandibule,7,loot2],
    [userInfo.INVENTAIRE.inventaire.Crâne,8,loot1],
    [userInfo.INVENTAIRE.inventaire.Sang,8,loot2],
    [userInfo.INVENTAIRE.inventaire.Aile,9,loot1],
    [userInfo.INVENTAIRE.inventaire.Oreille,9,loot2],
    [userInfo.INVENTAIRE.inventaire.Corne,10,loot1],
    [userInfo.INVENTAIRE.inventaire.Oeil,10,loot2],
    [userInfo.INVENTAIRE.inventaire.Pollen,3,loot2],
    [userInfo.INVENTAIRE.inventaire.HerbeMedic,4,loot2],
    [userInfo.INVENTAIRE.inventaire.Azurite,6,loot1],
    [userInfo.INVENTAIRE.inventaire.Diamant,6,loot2]
  ]
  let inventory = "--------------------";
  for (i=0 ; i<InventaireLIST.length ; i=i+1){
    if (InventaireLIST[i][0] > 0) {
      inventory = `${inventory}\n${MOB[InventaireLIST[i][1]].InventaireLIST[i][2] [0]}  ${InventaireLIST[i][0]}`;
    }
  }
  // équipement !
