...
module.exports.run = async (bot, message, args, data, userInfo) => {
  ...
  async function LootMob(MOB) {
      ...
      const Nombre = [
        [nombre=Math.floor(Math.random() * 3) + 1,"Griffe",Griffe(nombre)],
        [nombre=Math.floor(Math.random() * 2) + 1,"Peau",Peau(nombre)],
        [nombre=1,"Viande",Viande(nombre)],
        [nombre=Math.floor(Math.random() * 2) + 1,"Bois",Bois(nombre)],
        [nombre=Math.floor(Math.random() * 4) + 1,"Sabot",Sabot(nombre)],
        [nombre=Math.floor(Math.random() * 3) + 1,"Pollen",Pollen(nombre)],
        [nombre=Math.floor(Math.random() * 3) + 1,"Azurite",Azurite(nombre)],
        [nombre=Math.floor(Math.random() * 4) + 1,"HerbeMedic",HerbeMedic(nombre)],
        [nombre=Math.floor(Math.random() * 5) + 1,"Dent",Dent(nombre)],
        [nombre=Math.floor(Math.random() * 5) + 1,"Ecaille",Ecaille(nombre)],
        [nombre=Math.floor(Math.random() * 6) + 3,"Azurite",Azurite(nombre)],
        [nombre=Math.floor(Math.random() * 2) + 1,"Diamant",Diamant(nombre)],
        [nombre=Math.floor(Math.random() * 4) + 1,"Carapace",Carapace(nombre)],
        [nombre=Math.floor(Math.random() * 2) + 1,"Mandibule",Mandibule(nombre)],
        [nombre=1,"Crâne",Crâne(nombre)],
        [nombre=Math.floor(Math.random() * 4) + 1,"Sang",Sang(nombre)],
        [nombre=Math.floor(Math.random() * 2) + 1,"Aile",Aile(nombre)],
        [nombre=Math.floor(Math.random() * 2) + 1,"Oreille",Oreille(nombre)],
        [nombre=Math.floor(Math.random() * 2) + 1,"Corne",Corne(nombre)],
        [nombre=Math.floor(Math.random() * 2) + 1,"Oeil",Oeil(nombre)]
      ];
  ...
  function Griffe(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Griffe": userInfo.INVENTAIRE.inventaire.Griffe + Nombre[x][0]
    });}
  function Peau(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Peau": userInfo.INVENTAIRE.inventaire.Peau + Nombre[x][0]
    });}
    function Viande(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Viande": userInfo.INVENTAIRE.inventaire.Viande + Nombre[x][0]
    });}
    function Bois(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Bois": userInfo.INVENTAIRE.inventaire.Bois + Nombre[x][0]
    });}
    function Sabot(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Sabot": userInfo.INVENTAIRE.inventaire.Sabot + Nombre[x][0]
    });}
    function Pollen(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Pollen": userInfo.INVENTAIRE.inventaire.Pollen + Nombre[x][0]
    });}
    function Azurite(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Azurite": userInfo.INVENTAIRE.inventaire.Azutite + Nombre[x][0]
    });}
    function HerbeMedic(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.HerbeMedic": userInfo.INVENTAIRE.inventaire.HerbeMedic + Nombre[x][0]
    });}
    function Dent(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Dent": userInfo.INVENTAIRE.inventaire.Dent + Nombre[x][0]
    });}
    function Ecaille(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Ecaille": userInfo.INVENTAIRE.inventaire.Ecaille + Nombre[x][0]
    });}
    function Diamant(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Diamant": userInfo.INVENTAIRE.inventaire.Diamant + Nombre[x][0]
    });}
    function Carapace(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Carapace": userInfo.INVENTAIRE.inventaire.Carapace + Nombre[x][0]
    });}
    function Mandibule(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Mandibule": userInfo.INVENTAIRE.inventaire.Mandibule + Nombre[x][0]
    });}
    function Crâne(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Crâne": userInfo.INVENTAIRE.inventaire.Crâne + Nombre[x][0]
    });}
    function Sang(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Sang": userInfo.INVENTAIRE.inventaire.Sang + Nombre[x][0]
    });}
    function Aile(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Aile": userInfo.INVENTAIRE.inventaire.Aile + Nombre[x][0]
    });}
    function Oreille(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Oreille": userInfo.INVENTAIRE.inventaire.Oreille + Nombre[x][0]
    });}
    function Corne(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Corne": userInfo.INVENTAIRE.inventaire.Corne + Nombre[x][0]
    });}
    function Oeil(x) {
    bot.updateUserInfo(message.member, {
      "users.$.INVENTAIRE.inventaire.Oeil": userInfo.INVENTAIRE.inventaire.Oeil + Nombre[x][0]
    });}
