...
module.exports.run = async (bot, message, args, data, userInfo) => {
  ...
  async function LootMob(MOB) {
      ...
      const Nombre = [
        [Math.floor(Math.random() * 3) + 1,"Griffe",Griffe()],
        [Math.floor(Math.random() * 2) + 1,"Peau",Peau()],
        [1,"Viande",Viande()],
        [Math.floor(Math.random() * 2) + 1,"Bois",Bois()],
        [Math.floor(Math.random() * 4) + 1,"Sabot",Sabot()],
        [Math.floor(Math.random() * 3) + 1,"Pollen",Pollen()],
        [Math.floor(Math.random() * 3) + 1,"Azurite",Azurite()],
        [Math.floor(Math.random() * 4) + 1,"HerbeMedic",HerbeMedic()],
        [Math.floor(Math.random() * 5) + 1,"Dent",Dent()],
        [Math.floor(Math.random() * 5) + 1,"Ecaille",Ecaille()],
        [Math.floor(Math.random() * 6) + 3,"Azurite",Azurite()],
        [Math.floor(Math.random() * 2) + 1,"Diamant",Diamant()],
        [Math.floor(Math.random() * 4) + 1,"Carapace",Carapace()],
        [Math.floor(Math.random() * 2) + 1,"Mandibule",Mandibule()],
        [1,"Crâne",Crâne()],
        [Math.floor(Math.random() * 4) + 1,"Sang",Sang()],
        [Math.floor(Math.random() * 2) + 1,"Aile",Aile()],
        [Math.floor(Math.random() * 2) + 1,"Oreille",Oreille()],
        [Math.floor(Math.random() * 2) + 1,"Corne",Corne()],
        [Math.floor(Math.random() * 2) + 1,"Oeil",Oeil()]
      ];
      ...
      function Griffe() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Griffe": userInfo.INVENTAIRE.inventaire.Griffe + Nombre[j][0]
        });}
      function Peau() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Peau": userInfo.INVENTAIRE.inventaire.Peau + Nombre[k][0]
        });}
        function Viande() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Viande": userInfo.INVENTAIRE.inventaire.Viande + Nombre[j][0]
        });}
        function Bois() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Bois": userInfo.INVENTAIRE.inventaire.Bois + Nombre[k][0]
        });}
        function Sabot() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Sabot": userInfo.INVENTAIRE.inventaire.Sabot + Nombre[j][0]
        });}
        function Pollen() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Pollen": userInfo.INVENTAIRE.inventaire.Pollen + Nombre[k][0]
        });}
        function Azurite() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Azurite": userInfo.INVENTAIRE.inventaire.Azutite + Nombre[j][0]
        });}
        function HerbeMedic() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.HerbeMedic": userInfo.INVENTAIRE.inventaire.HerbeMedic + Nombre[k][0]
        });}
        function Dent() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Dent": userInfo.INVENTAIRE.inventaire.Dent + Nombre[j][0]
        });}
        function Ecaille() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Ecaille": userInfo.INVENTAIRE.inventaire.Ecaille + Nombre[k][0]
        });}
        function Diamant() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Diamant": userInfo.INVENTAIRE.inventaire.Diamant + Nombre[k][0]
        });}
        function Carapace() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Carapace": userInfo.INVENTAIRE.inventaire.Carapace + Nombre[j][0]
        });}
        function Mandibule() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Mandibule": userInfo.INVENTAIRE.inventaire.Mandibule + Nombre[k][0]
        });}
        function Crâne() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Crâne": userInfo.INVENTAIRE.inventaire.Crâne + Nombre[j][0]
        });}
        function Sang() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Sang": userInfo.INVENTAIRE.inventaire.Sang + Nombre[k][0]
        });}
        function Aile() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Aile": userInfo.INVENTAIRE.inventaire.Aile + Nombre[j][0]
        });}
        function Oreille() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Oreille": userInfo.INVENTAIRE.inventaire.Oreille + Nombre[k][0]
        });}
        function Corne() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Corne": userInfo.INVENTAIRE.inventaire.Corne + Nombre[j][0]
        });}
        function Oeil() {
        bot.updateUserInfo(message.member, {
          "users.$.INVENTAIRE.inventaire.Oeil": userInfo.INVENTAIRE.inventaire.Oeil + Nombre[k][0]
        });}
