...
module.exports.run = async (bot, message, args, data, userInfo) => {
  ...
  async function LootMob(MOB) {
      ...
      const Nombre = [
        [Math.floor(Math.random() * 3) + 1,"Griffe",Griffe(j)],
        [Math.floor(Math.random() * 2) + 1,"Peau",Peau(k)],
        [1,"Viande",Viande(j)],
        [Math.floor(Math.random() * 2) + 1,"Bois",Bois(k)],
        [Math.floor(Math.random() * 4) + 1,"Sabot",Sabot(j)],
        [Math.floor(Math.random() * 3) + 1,"Pollen",Pollen(k)],
        [Math.floor(Math.random() * 3) + 1,"Azurite",Azurite(j)],
        [Math.floor(Math.random() * 4) + 1,"HerbeMedic",HerbeMedic(k)],
        [Math.floor(Math.random() * 5) + 1,"Dent",Dent(j)],
        [Math.floor(Math.random() * 5) + 1,"Ecaille",Ecaille(k)],
        [Math.floor(Math.random() * 6) + 3,"Azurite",Azurite(j)],
        [Math.floor(Math.random() * 2) + 1,"Diamant",Diamant(k)],
        [Math.floor(Math.random() * 4) + 1,"Carapace",Carapace(j)],
        [Math.floor(Math.random() * 2) + 1,"Mandibule",Mandibule(k)],
        [1,"Crâne",Crâne(j)],
        [Math.floor(Math.random() * 4) + 1,"Sang",Sang(k)],
        [Math.floor(Math.random() * 2) + 1,"Aile",Aile(j)],
        [Math.floor(Math.random() * 2) + 1,"Oreille",Oreille(k)],
        [Math.floor(Math.random() * 2) + 1,"Corne",Corne(j)],
        [Math.floor(Math.random() * 2) + 1,"Oeil",Oeil(k)]
      ];
